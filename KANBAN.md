...
- [ ] Redux style reference — restore image conditioning | Priority: P1 | Started: 2026-09-02 | Review Started: 2026-09-02 | Owner: drew-valentine
  ...
  - Scope:
    ...
    - [x] H76 — after the token-pooling fix (bce0aae), the cartoon deck's four matrix cards re-rendered at Medium strength match the reference palette more closely than any earlier run (orange-red alien plants, cyan crystals, yellow sky), 4 of 4 on-style with zero defects. Medium-strength decks had been seeing only the top-left third of their reference. Sheet h76-temur-pooling.jpg.
